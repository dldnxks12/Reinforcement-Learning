...
class NOISYActor(nn.Module):
    def __init__(self, state_dim, action_dim, action_bound, device):
        ...
        # self.fc1 = NoisyLayer(state_dim, 512)
        # self.fc2 = NoisyLayer(512, 512)
        # self.fc3 = NoisyLayer(512, action_dim)
...
class Critic(nn.Module):
    def __init__(self, state_dim, action_dim, device):
        ...
        # self.fc_A1   = nn.Linear(state_dim + action_dim, 512)
        # self.fc_A2   = nn.Linear(512, 512)
        # self.fc_Aout = nn.Linear(512, 1)
        #
        # self.fc_B1   = nn.Linear(state_dim + action_dim, 512)
        # self.fc_B2   = nn.Linear(512, 512)
        # self.fc_Bout = nn.Linear(512, 1)
