...
HEIGHT = 5 # 그리드월드 세로
WIDTH = 5  # 그리드월드 가로
TRANSITION_PROB = 1 # State Transition Probability --- DP는 MDP 모델을 알아야한다.
POSSIBLE_ACTIONS = [0, 1, 2, 3]  # 4 action states : 좌, 우, 상, 하
ACTIONS = [(-1, 0), (1, 0), (0, -1), (0, 1)]  # 좌표로 나타낸 행동
REWARDS = [] # Return 계산을 위한 reward list

# DP Setting
class Env:
    def __init__(self):
        self.transition_probability = TRANSITION_PROB # Set this probability to 1 because of deterministic policy
